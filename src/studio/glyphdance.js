...
/**
 * glyphdance theme — built by `npx astryx theme build`
 * Import the CSS file alongside this module:
 *
 *   import { glyphdanceTheme } from './glyphdance';
 *   import './glyphdance.css';
 */
export const glyphdanceTheme = {
  name: 'glyphdance',
  __built: true,
  tokens: {
  ...
  __localTokenLineage: ["neutral","glyphdance"],
  components: {
    "heading": {
      "level:1": {
